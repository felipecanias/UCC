 describe('editEmployeeTest', () => {
   it('Edita correctamente un empleado', () => {
     cy.visit('localhost:4200') // URL del front
     ...
     cy.get('.form-control').type('New Employee Modified');
 
     // Envía el formulario
     cy.get('.btn').click();
 
     // Verifica que el nombre fue actualizado correctamente
     cy.get(':nth-child(2) > :nth-child(2)').should('contain', 'New Employee Modified');
   });
 });
